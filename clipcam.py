...
def clipcam(CLIP_MODEL_NAME, CAM_MODEL_NAME, images, sentence, DISTILL_NUM = 0, ATTACK = None, WEIGHT_FLAG = True, GPU_ID = 'cpu'):
    model, target_layer, reshape_transform = getCLIP(
        model_name=CLIP_MODEL_NAME, gpu_id=GPU_ID, weight_flag= WEIGHT_FLAG)
...
parser.add_argument("--image_path", type=str, default="images/10577.jpg",
...
parser.add_argument("--sentence", type=str, default='Grab the sunglass for me',
                    help="input text")

##check to use weight file##
parser.add_argument("--weight_flag", type=bool, default=True,
                    help="input text")
...
final_img = clipcam(args.clip_model_name, args.cam_model_name, images, args.sentence, args.distill_num, args.attack_type, args.weight_flag, args.gpu_id)
