...
import torch
import ttach as tta
from pytorch_grad_cam_modified.activations_and_gradients import ActivationsAndGradients_original
...
class BaseCAM:
    def __init__(self, 
        ...
        self.activations_and_grads = ActivationsAndGradients_original(self.model, 
